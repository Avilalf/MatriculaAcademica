...
public class ConsultaProgramacionAcademicaUI extends javax.swing.JFrame {
     ...
     */
    public ConsultaProgramacionAcademicaUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaProgramacionAcademicaUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaProgramacionAcademicaUI().setVisible(true);
            }
        });
    }
